...
<body>
  <div class="frame">
   ...
   <div class="container">
     <div class="thema">
       <!-- 테마 이미지 들어가는 부분 -->
       <div class ="thema_img"><img src="<c:url value="/resources/static/leisure.png"/>" width="350" height="350"  >
         ...
         <li>
      	...
      	<form method="POST" action="label/tour">
	        <label for="boardHeadText1" class="text_label">
	          <input type="checkbox" name="text_label_1" id="text_label1" class="text_chbox" value="natural"/>
	          <span class ="txt_style">자연</span>
	        </label>
	        
	        <label for="boardHeadText2" class="text_label">
	          <input type="checkbox" name="text_label_2" id="text_label2" class="text_chbox" value="Healing"/>
	        ...
	        <label for="boardHeadText4" class="text_label">
	          <input type="checkbox" name="text_label_4" id="text_label4" class="text_chbox" value="Property"/>
	          <span class ="txt_style">실내</span>
	        </label>
	        ...
	        <label for="boardHeadText6" class="text_label">
	          <input type="checkbox" name="text_label_6" id="text_label6" class="text_chbox" value="Leisure"/>
	          <span class ="txt_style">레저</span>
	        </label>
	        
	        <label for="boardHeadText7" class="text_label">
	          <input type="checkbox" name="text_label_7" id="text_label7" class="text_chbox" value="스포츠"/>
	          <span class ="txt_style">스포츠</span>
	        </label>
	          
	        <label for="boardHeadText8" class="text_label">
	          <input type="checkbox" name="text_label_8" id="text_label8" class="text_chbox" value="Tourism"/>
	          <span class ="txt_style">관광</span>
	        </label>
	       ...
	       <label for="boardHeadText10" class="text_label">
	         <input type="checkbox" name="text_label_10" id="text_label10" class="text_chbox" value="Event"/>
	         <span class ="txt_style">이벤트</span>
	       </label>
	       ...
	       <label for="boardHeadText12" class="text_label">
	         <input type="checkbox" name="text_label_12" id="text_label12" class="text_chbox" value="체험"/>
	         <span class ="txt_style">체험</span>
	       </label>
	       </li>
	      </ul>
