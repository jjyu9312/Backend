...
<body>
  <div class="frame">
   ...
   <div class="container">
     <div class="thema">
       <!-- 테마 이미지 들어가는 부분 -->
       <div class ="thema_img"><img src="<c:url value="/resources/static/ocean.png"/>" width="350" height="350"  >
     ...
     <div class="box">
      ...
      <form method="POST" action="label/tour">
        ...
        <label for="boardHeadText4" class="text_label">
          <input type="checkbox" name="text_label_4" id="text_label4" class="text_chbox" value="Tourism"/>
        ...
        <label for="boardHeadText8" class="text_label">
          <input type="checkbox" name="text_label_8" id="text_label8" class="text_chbox" value="Coast"/>
          <span class ="txt_style">해안</span>
        </label>
       ...
       <label for="boardHeadText10" class="text_label">
         <input type="checkbox" name="text_label_10" id="text_label10" class="text_chbox" value="Leisure"/>
       ...
       <label for="boardHeadText12" class="text_label">
         <input type="checkbox" name="text_label_12" id="text_label12" class="text_chbox" value="Plant"/>
         <span class ="txt_style">식물</span>
       </label>
       </li>
      </ul>
